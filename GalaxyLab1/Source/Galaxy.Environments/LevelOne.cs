  ...
  public class LevelOne : BaseLevel
  {
    ...
    public LevelOne()
    {
      ...
      for (int i = 0; i < 5; i++)
      {
        ...
        int positionX = 180 + i * (ship.Width + 50);
      ...
      for (int i = 0; i < 5; i++)
      {
          var Vrag = new Vrag(this);
          int positionY = Vrag.Height + 10;
          int positionX = 150 + i * (Vrag.Width + 50);

          Vrag.Position = new Point(positionX, positionY);
      ...
      for (int i = 0; i < 5; i++)
      {
          var Vrag2 = new Vrag2(this);
          int positionY = Vrag2.Height + 2;
          int positionX = 130 + i * (Vrag2.Width + 50);

          Vrag2.Position = new Point(positionX, positionY);
